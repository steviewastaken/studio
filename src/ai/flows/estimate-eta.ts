...
const prompt = ai.definePrompt({
  ...
  prompt: `Estimate the delivery time in minutes for the following request.
...
Your response MUST be a valid JSON object that conforms to the required output schema.
